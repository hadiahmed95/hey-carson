...
class ProjectAvailableAgainMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: "Request Reopened: {$this->project->name}",
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            ...
            <p>The project titled <strong>{$this->project->name}</strong> is available again, as it was released by an expert or our admin team.</p>
