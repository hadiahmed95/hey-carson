...
@section('content')
    ...
    <p>A fellow merchant has asked a question about <b>{{ $theme_name }}</b>. Since you’ve previously written a review for this theme, we thought you might be able to help out.</p>
