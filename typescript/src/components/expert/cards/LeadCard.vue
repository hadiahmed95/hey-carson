  ...
  <div class="border rounded-md shadow-sm bg-white mb-4 p-card-padding">
    ...
    <div class="flex flex-col gap-2 mb-4">
      <div class="flex items-center justify-between">
        <p
          class="font-semibold text-custom1 px-1 py-1 rounded-sm"
          :class="{
      ...
      <router-link
        ...
        class="font-semibold text-link hover:underline cursor-pointer"
      >
        {{ projectName }}
      </router-link>
    </div>
    ...
    <div class="flex justify-between gap-4">
      <div class="flex items-center gap-4">
        ...
        <div class="flex flex-wrap items-center gap-4 text-h4">
          ...
          <h4 v-if="shopifyPlan">Shopify plan: {{ shopifyPlan }}</h4>
