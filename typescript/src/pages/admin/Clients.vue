...
const totalClients = computed(() => adminStore.totalClients);  
...
const fetchClients = async (page = 1, resetData = false) => {
  ...
  try {
    ...
    // KEY: Use the same pattern as Listings.vue - pass appendData parameter
    await adminStore.fetchClients(params, !resetData && page > 1);
