<template>
  <main class="w-full">
    ...
    <EmptyState class="w-full" :icon="Gallery" content="No customer stories yet - but your past work matters! Show your skills<br/> in action, like “Shopify redesign that boosted sales by 35%.”"/>
  </main>
</template>
