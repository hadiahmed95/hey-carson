<template>
  <div style="display: ruby-text;">
    <svg class="icon" fill="red" width="15px" height="15px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <span style="font-size: 10px; color: red; margin-bottom:4px; opacity: 1 !important;">retry</span>
  </div>
</template>
<script>
export default {
  name: 'ResendMessageIcon'
}
</script>
