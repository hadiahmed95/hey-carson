...
export default {
  ...
  methods: {
    async tryLogin() {
      ...
      await axios.post('api/login', {email: this.form.email, password: this.form.password, role: 'expert'}).then(res => {
  ...
  <LoginLayout>
    ...
    <BlockStack gap="600">
      ...
      <Text variant="bodyMd" as="p" alignment="center" tone="subdued">
        Don't have account?
        <Link :removeUnderline="true" external target="_blank" url="https://shopifygroup.typeform.com/to/L1tHGWMe?typeform-source=shopexperts.com" >Sign up</Link>
      </Text>
    </BlockStack>
  </LoginLayout>
</template>
